...
<div class="">
    <div class="box ">
        <div class="box-header">
            <h2 style="font-weight: bold;font-size:1.2rem"><i class="halflings-icon user"></i><span class="break"></span>Category Add</h2>
        </div>

        <div class="container">
            {{-- <div class="text"> --}}
            {{-- </div> --}}
            <form action="/add-category-store" method="POST">
                @csrf
               <div class="form-row">
