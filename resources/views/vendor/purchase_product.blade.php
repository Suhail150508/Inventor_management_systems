              ...
              <tbody>
                @foreach ($products as $key => $product )
                    <tr>
                        ...
                        <td class="center">{{ $product->origin }}</td>
                        <td class="center">{{ $product->year }}</td>
                        <td class="center">{{ $product->unit_amount }}</td>
                        <td class="center">{{ $product->sales_amount }}</td>
                        <td class="center">{{ $product->quantity }}</td>
                        <td class="center">{{ $product->status }}</td>
                        <td class="center">{{ $product->expire_date }}</td>
                        {{-- <td class="center">
                        ...
                        <td class="center">
                            ...
                            <div class="span1">
                                <form method="post" action="{{ url('/product-delete/'.$product->id ) }}" style="margin-left:.1;">
                                    @csrf
                                    @method('DELETE')
