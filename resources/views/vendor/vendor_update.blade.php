...
<div class="">
    <div class="box ">
        ...
        {{-- <form action="{{ route('customer.update', $editinvestor->id) }}" method="post" enctype="multipart/form-data" style="text-align: center">
            ...
            @method('PUT') --}}
        <div class="container">
            <form action="{{ url('/vendor-update', $edit_vendors->id) }}" method="POST">
                @csrf
                @method('PUT')
               <div class="form-row">
                  <div class="input-data">
                  <input type="text" class="form-control" name="name"  value="{{ $edit_vendors->name }}">
                     {{-- <div class="underline"></div> --}}
                     <label for="">Name</label>
                  </div>
                  <div class="input-data">
                    <input type="email" class="form-control" name="email" value="{{ $edit_vendors->email }}">
                     {{-- <div class="underline"></div> --}}
               ...
               <div class="form-row">
                   <div class="input-data">
                       <input type="text" class="form-control" name="mobile" value="{{ $edit_vendors->mobile }}">
                       {{-- <div class="underline"></div> --}}
                       <label for="">Mobile</label>
                    </div>
                    <div class="input-data">
                        <input type="text" class="form-control" name="vendor_origin" value="{{ $edit_vendors->vendor_origin }}">
                        {{-- <div class="underline"></div> --}}
                ...
                <div class="form-row">
                    <div class="input-data">
                        <input type="text" class="form-control" name="address" value="{{ $edit_vendors->address }}">
                        {{-- <div class="underline"></div> --}}
