        ...
        <div class="card-body">
            ...
            <form action="/sales-invoice-update" method="POST">
                ...
                <div style="width:95%;text-align:center">
                    ...
                    <strong class="invoice_name">Sales Invoice</strong>
                ...
                <div style="display: flex;justify-content:space-around">
                    ...
                    <div style="display:flex;margin:0px 6px">
                        ...
                        <select class="form-control status_select" name="status" id="status" required style="width:4rem;">
                    ...
                    <div class="discount" style="background-color:#d9d9ebc6;padding:8px;">
                        ...
                        <div>
                            <small class="small" style="font-weight:bold;color:#000;">Sub Total: <input type="text" class="form-control0" id="subtotal" name="sub_total" value="{{ $sales_invoice_edits->sub_total }}"></small>

                        </div>
                        <div>
                            <small class="small" style="font-weight:bold;color:#000;padding-top:-1rem">Discount: <input type="text" class="form-control1" id="discount" name="discount"  value="{{ $sales_invoice_edits->discount }}"></small>

                        </div>
                        <div>
                            <small class="small" style="font-weight:bold;color:#000;padding-top:-1rem">Total: <input type="text" class="form-control2" id="total" name="total"  value="{{ $sales_invoice_edits->total}}"></small>

                        </div>
                        <div>
                            <small class="small" style="font-weight:bold;color:#000;padding-top:-1rem">Paid: <input type="text" class="form-control3" id="paid" name="paid"  value="{{ $sales_invoice_edits->paid }}"></small>

                        </div>
                        <div>
                            <small class="small" style="font-weight:bold;color:#000;padding-top:-1rem">Due: <input type="text" class="form-control4" id="due" name="due"  value="{{ $sales_invoice_edits->due }}"></small>
