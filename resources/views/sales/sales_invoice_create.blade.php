            ...
            <form action="/sales-invoice-store" method="POST">
                    ...
                    <div class="customer_part">
                        ...
                        @endphp
                            ...
                            <div class="customer_body">
                                <select class="form-control customer_select"  name="customer_id"  id="selectField" required style="width:60%">

                                    <option style="" value=""></option>
                                    @foreach ($vendors as $vendor )
                                    <option class="customer_name" value="{{ $vendor->id }}">{{ $vendor->name  }}</option>
                                    @endforeach
                                </select>
                            </div>
                ...
                <div style="display: flex;justify-content:space-around">
                    ...
                    <div style="display:flex;">
                        <strong class="tatus">Select Status</strong>
                ...
                <div style="text-align: center;margin-top:10rem">
                    ...
                    <button type="button" class="btn" onclick="GetPrint()" class="btn btn-primary print ">Print</button>
                </div>
