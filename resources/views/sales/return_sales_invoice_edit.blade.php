        ...
        <div class="card-body">
            ...
            <form action="/sales-invoice-update" method="POST">
                ...
                <div class="shift" style="margin-top:-8rem;margin-bottom:10rem;width:20%">
                        ...
                        <select class="form-control" id="selectField" name="customer_id"  style="width: 20rem" value="{{ $return_sales_invoice->customer_id }}">
                            @php
                                $products = App\Models\Customer::find($return_sales_invoice->customer_id);
                            @endphp
                ...
                <div style="float: right;margin:4rem 2rem;background-color:#d9d9ebc6;padding:8px;width:21%;">
                    ...
                    <p style="font-weight:bold;font-size:1.7rem">Sub Total: <input type="text" class="form-control" id="subtotal" name="sub_total" style="width: 60px;height:16px" value="{{ $return_sales_invoice->sub_total }}"></p>
                    <p style="font-weight:bold;font-size:1.7rem">Discount: <input type="text" class="form-control" id="discount" name="discount" style="width: 60px;height:16px" value="{{ $return_sales_invoice->discount }}"></p>
                    <p style="font-weight:bold;font-size:1.7rem">Total: <input type="text" class="form-control" id="total" name="total" style="width: 60px;height:16px" value="{{ $return_sales_invoice->total }}"></p>
                    <p style="font-weight:bold;font-size:1.7rem">Paid: <input type="text" class="form-control" id="paid" name="paid" style="width: 60px;height:16px" value="{{ $return_sales_invoice->paid }}"></p>
                    <p style="font-weight:bold;font-size:1.7rem">Due: <input type="text" class="form-control" id="due" name="due" style="width: 60px;height:16px" value="{{ $return_sales_invoice->due }}"></p>
                </div>
