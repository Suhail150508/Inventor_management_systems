            ...
            <form action="/sales-invoice-update" method="POST">
                ...
                <div style="display: flex;justify-content:space-around">
                    ...
                    <div style="background-color:#d9d9ebc6;padding:8px;">
                        ...
                        <div>
                            <small style="font-weight:bold;color:#000;font-size:1rem;">Sub Total: <input type="text" class="form-control" id="subtotal" name="sub_total" style="width: 60px;height:9px;margin-left:2rem" value="{{ $return_sales_invoice->sub_total }}"></small>

                        </div>
                        <div>
                            <small style="font-weight:bold;color:#000;font-size:1rem;padding-top:-1rem">Discount: <input type="text" class="form-control" id="discount" name="discount" style="width: 60px;height:9px;margin-left:2rem" value="{{ $return_sales_invoice->discount }}"></small>

                        </div>
                        <div>
                            <small style="font-weight:bold;color:#000;font-size:1rem;padding-top:-1rem">Total: <input type="text" class="form-control" id="total" name="total" style="width: 60px;height:9px;margin-left:4rem" value="{{ $return_sales_invoice->total}}"></small>

                        </div>
                        <div>
                            <small style="font-weight:bold;color:#000;font-size:1rem;padding-top:-1rem">Paid: <input type="text" class="form-control" id="paid" name="paid" style="width: 60px;height:9px;margin-left:4.3rem" value="{{ $return_sales_invoice->paid }}"></small>

                        </div>
                        <div>
                            <small style="font-weight:bold;color:#000;font-size:1rem;padding-top:-1rem">Due: <input type="text" class="form-control" id="due" name="due" style="width: 60px;height:9px;margin-left:4.5rem" value="{{ $return_sales_invoice->due }}"></small>
