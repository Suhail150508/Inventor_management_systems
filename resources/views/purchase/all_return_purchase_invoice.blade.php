...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header" data-original-title>
            <h2><i class="halflings-icon user"></i><span class="break"></span>Return Purchase Invoices</h2>
            {{-- <div class="box-icon">
        ...
        <div>
            <form action="/search-vendor-invoice" method="POST" class="row pt-5" style="display:flex;justify-content:center;padding:.2rem;margin-top:5rem">
                @csrf
                @php
        ...
        <div class="box-content">
            ...
            @endforeach
                ...
                <div class="discount">
                    <p class="d_inner">Total: {{ $total }}  </p>
                    <p class="d_inner">Total Paid: {{ $paid }} </p>
                    <p class="d_inner">Total Due: {{ $due }} </p>
                </div>
        </div>
    </div>
</div>
