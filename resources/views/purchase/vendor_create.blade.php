...
<div class="">
    <div class="box ">
        <div class="box-header">
            <h2  style="font-weight: bold;font-size:1.2rem"><i class="halflings-icon user"></i><span class="break"></span>Vendor Create</h2>
        </div>
        ...
        {{-- <form action="{{ route('customer.update', $editinvestor->id) }}" method="post" enctype="multipart/form-data" style="text-align: center">
            ...
            @method('PUT') --}}
        <div class="container">
            <form class="" action="{{ url('/vendor-create') }}" method="POST" enctype="multipart/form-data">
                @csrf
               <div class="form-row">
               ...
               <div class="form-row">
                   <div class="input-data">
                    ...
                    <div class="input-data">
                        <input type="text" class="form-control" name="vendor_origin">
                        {{-- <div class="underline"></div> --}}
